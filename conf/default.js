...
module.exports = {
	...
	// API key
	apikey: 'uI1i/eyvLW9OdS2Ejsz9whztGoONM6eu',
	...
	// Log level of the application. Can be set to (in order of most-verbose to least):
	...
	session: {
		...
		encryptionKey: 'yF8EpDQSpLvgqGxd1PD5OBPlVb455mLHf2eRMiWKYAs=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '0/eJIPnrwvS8WnZnmUeDYjnaElpuNJuS6CNwa6inVMUu7jhgYAq+9r1wYTCx+xf8GiiBHY7t0Y814RDuH3r2/Q==',
		secret: 'CtlUpeSDT5M5bAkApxPonrjZshGGBsLY', // should be a large unguessable string
	...
	cookieSecret: '5KfFmTfPTQ/OBzoj1jZu+RP83gcv5RTT',
